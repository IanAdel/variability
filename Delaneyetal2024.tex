...
\begin{abstract}
  ...
  In another numerical experiment, we show that the changing channel size results in sediment transport capacity peaking before the maximum water discharge.
...
To accurately explain observed changes to sediment transport in glacierized catchments requires examining the processes controlling sediment discharge and its variations with water discharge  \citep[e.g.][]{riihimaki2005,swift2005}.
