...
To generalize these cases, the Fieschergletscher case is referred to as \alpine{} and is exemplified by relatively thin ice thickness ($h_o$: xxx), low discharge (< $20$\unit{m}$^3$\,\unit{s}$^{-1}$) and high diurnal variability in discharge.
The Leverett glacier case is referred to as \icesheet{} and is exemplified by thick ice  ($h_o$: xxx), high water discharge (< $300$\unit{m}$^3$\,\unit{s}$^{-1}$)  and low diurnal variability in discharge.
