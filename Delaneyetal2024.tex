...
\begin{abstract}
 Sediment transport capacity in both subaerial and subglacial channels depends on the shear stress exerted across the channel bottom, which varies with water velocity and channel width.
  ...
  This processes occurs as water is pressurized by the ice above, and channels grow in response to the frictional heating of water flowing through them. 
  ...
  Yet, results and formulations of subglacial sediment transport capacity show that its variability approaches that of subaerial systems when subglacial channel size is in equilibrium with water discharge. 
...
\authorcontribution{
  ...
  M.A.W. and D.F. provided data from Fieschergletscher and contributed to the analysis.
