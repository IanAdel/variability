...
\label{sect:intro}
  ...
  In some of these regions, increased water discharge and glacier melt have been attributed to the greater sediment transport \cite{bendixen2017,costa2017,li2021}.
...
Consistent with the individual case (Figure ~\ref{fig:model_outs}), the subaerial systems' reduce variability in width-integrated shear stress occurs  as the evolving channel width accommodates some of the reduced shear stress variability in subaerial systems (Figure~\ref{fig:range} i).
  ...
  Conversely, sediment transport in most subaerial systems increases with water discharge and bed slope, with the bed slope probably being more stable over yearly to century-scale time periods \cite<Section~\ref{sect:fluv}; e.g.>{muller1968,whipple1999,wong2006,wickert2019}. 
  ...
  Such a large quantity of sediment transported at lower water discharges may occur in part because sediment transport capacity responds the size of the glacier conduit, in addition to water discharge (Section~\ref{sect:sub_mode}).
