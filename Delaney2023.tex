...
%TODO: 
%Check with Daniel and Mauro about data
...
Variability in sediment transport capacity across a channel's width can be higher in subglacial channels compared to subaerial ones, but also the variability might not be substantially different.
Furthermore, the timing of peak sediment discharge conditions with respect to water discharge occurs on the rising limb of the hydrograph in subglacial systems, as opposed to the peak in subaerial systems.
