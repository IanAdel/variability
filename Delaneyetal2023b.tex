...
In some of these regions, increased water discharge and glacier melt have been interpreted to yeild greater sediment transport capacity \citep{bendixen2017,costa2017,li2021}.
...
\begin{figure}[h]
  ...
  \caption{Parameterization outputs resulting from the hydrographs shown in panels a and e for the cases called \alpine (a-d) and \icesheet{} (e-h). Gray (black) lines in a and e represent the subglacial channel size (water discharge).  In other panels, blue lines represent outputs from the subglacial channel, while orange lines represent the subaerial channel.
    ...
    \ian{Andrew's comment: for a given channel width, subglacial channels are more effective at mobilising and transporting sediment that subaerial ones}
  } 
...
The strong link between sediment discharge capacity and open channel flow conditions could be manifested ~ $20$\,\unit{km} downstream of the Leverett measurement site, where a strong correlation persists between sediment plume size and water discharge in to the Kangerlussuaq fjord \citep{mcgrath2010}.
...
The threshold of motion for sediment can be reached more frequently, and across a range of water discharges, in subglacial systems.
Therefore, glaciers could well  persist in a supply-limited regime, where sediment discharge also scales with sediment production from glacier quarrying and abrasion, along with melt water access \citep[e.g.][]{herman2015,ugelvig2018,delaney2023}.
...
Note, however, that the absences of lags between sediment and water discharge may suggest that sediment is mobilized close to the measurement stations, as opposed to distal areas of the glacier bed  \citep[Figure~\ref{fig:model_outs}\,a and e][]{williams1989}.
\ian{might need to tighten this better}
...
\item the possibility for a consistent relationship between water and sediment discharge to represent processes such as subglacial sediment access, or open channel processes near the glacier margin, instead of subglacial sediment transport capacity.
