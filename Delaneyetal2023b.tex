...
\begin{abstract}
  ...
  Results of these parameterizations show that sediment transport capacity varies far more in subglacial channels compared to subaerial ones both over time and with respect to water discharge.
  ...
  This suggests that other processes such as sediment access or subaerial processes in the proglacial area are represented in the sediment discharge records.
...
\begin{figure}[h]
  \centering
    ...
    %The subglacial (blue) and subaerial (orange) systems are distinguished as are \alpine{} (a-c) and \icesheet{} (d-f).
...
Furthermore,  if a transport-limited regime may persist at the glacier margin, then the representation of subaerial transport processes could be represented just a short distance downstream, as sediment transport could be quickly adjusted to these variations.
...
This lies in contrast to other marine-terminating glacier fjords in Greenland that could represent the subglacial signal where less consistent relationships persist between water discharge, or melt extend, and sediment plume size \citep{tedstone2012}.
...
Code to make the figures, with links to data, can be found at \url{https://bitbucket.org/IanDelaney/xsection/src/master/}.
