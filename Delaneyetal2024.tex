...
Note that although variability between the events could remain comparable, water discharge forcings aggregated over periods longer than days may omit key sediment discharge characteristics, such as the timing of peaks in sediment transport capacity (Figure~\ref{fig:model_outs}).
