...
\title{Comparison of sediment transport capacity in subglacial and fluvial systems }
...
\begin{enumerate}
\item Sediment transport capacity varies more in pressurized subglacial channels compared to open fluvial ones, in response to changing water discharge due to the fixed size of their channels.  I can't fully undertand this. Too much information is overlain here. Separate concepts and give a more linear explanation. 
\item  As water discharge changes, differences in the sediment transport capacity response of fluvial vs subglacial channels  could substantially  impact ________ what kind? processes at proglacial margins as well as the interpretation of sediment transport records in glacial environments (?). 
\end{enumerate}

\abstract % 150 words
Sediment transport capacity depends largely on the velocity of water flowing through a channel and the channel width over which the sediment is mobilized.
In fluvial channels, changing water discharge can be accommodated by changes in? water depth, width of water flow [ is this width of water flow? ], and water velocity.
...
As a result, changing water discharge may result in modifying the water velocity, but not the  shape of the channel.
Parameterization of _______ indicates that a calculated? observed? increased variability in sediment transport capacity in subglacial systems occurs across a wide range of channel geometries and flow conditions.
The increased variability in sediment transport capacity impacts sediment transport processes and the interpretation of records of sediment transport from glacierized catchments.  This last sentence seems repetitive. I'm not fully understanding the results. Suggest revise after a complete update of the manuscript.

\vspace{0.5cm}

\laysummary % 200 words
It is well known that sediment transport capacity responds differently to changing water discharge in subglacial and fluvial channels.
In both subglacial and fluvial channels, sediment transport capacity depends, to the first order, on 1) the channel width over-which the sediment is mobilized  and 2) the shear stress applied by flowing water on sediment at the channel bottom.
The shear stress depends largely on water velocity.
In fluvial channels, changing water discharge will change the water depth, the water velocity (controlling sediment transport capacity),  and channel width (which dictates the span over which sediment transport  will occur).
...
This is hard to follow. Suggest you rewrite after greater clarity in the rest of the paper.
...
\begin{spacing}{1}
  ...
  Glaciers expel large quantities of sediment  from their termini \citep{hallet1996}. NEEDS MORE REFERENCES! Current 
  changes in glacier dynamics, geomorphology, and hydrology  have prompted numerous  recent studies of  sediment transport processes in cold regions, such as ________, _________, _____ \citep[e.g.][]{zhang2022}.    NEEDS MORE REFERENCES to fit with geographic sites!     Get the observations and measurements well stated, first. 
  Numerical models integrated with glacial monitoring data  consider evaluate?  the subglacial component of sediment discharge ___________at glacial termini? as a function of the availability of sediment from  erosion of bedrock or  prior existence of material and the sediment transport capacity generated by fluvial processes below the glacier ice? \citep{creyts2013,brinkerhoff2017,beaud2018,delaney2019}.
  These models  essentially represent subglacial sediment transport processes as similar to sediment transport processes in rivers, with the main difference being that when water flows through a subglacial conduit, it is pressurized by the ice above \citep{rothlisberger1972}.

 Shear stress between the water and the sediment that it flows over has a first-order control on the transport of sediment in both  subglacialand fluvial systems, \citep{shields1936} , but only if an adequate quantity of sediment is present so as to be transported fluvially (i.e. in a ``transport-limited'' regime). Confusing ; fluvial is used in too many contexts. How can you clarify this?
 between the water and the sediment that it flows over : this is an awkward phrasing. Is this correct: shear stress applied by the flowing water on the channel bed?
  The shear stress increases with increasing water velocity and roughness of the channel.
  Greater shear stress will mobilize increased quantities of sediment, along with larger sediment clasts. Confusing - need to specify grain size here. what is meant by clast?
  Sediment transport relationships described by  \citet{shields1936}, \citet{meyer1948},  and \citet{engelund1967} , for example, use shear stress, or an approximation thereof [ is this needed here?, confusing], to evaluate sediment transport capacity per unit width of ______?.
  The total sediment transport capacity across a channel's cross section depends on the integrated shear stress over the entire channel bed (Figure~\ref{fig:cartoon}). Here, the channel cross section refers to _______ (site a, Fig. ___) and the channel bed refers to ____ (site b, Fig. __)
Thus,  channel geometry plays a key role in sediment transport in both fluvial channels and subglacial ones because _________________ state the reason why \citep[e.g.][]{church2006,delaney2019}.
  
In a regime that is not transport limited [??? How is this different from the previous paragraph?]  the behavior of _________ what process? in subglacial channels differs from that in fluvial channels  in response to changing water discharge, Again, not following here... is there changing water discharge in the paragraph above?

  In subglacial environments? systems? , the water is pressurized and the changing? size of thechannel responds to the roughness of the walls and the water velocity   \citep[Figure~\ref{fig:cartoon}\,a and c; e.g. ][]{rothlisberger1972}. you have used "channel" many times in this sentence - confusing.
 Diurnal variations in water flux may cause water to flow through a conduit whose size does not respond at the same timescale(s) as the increase in water flux \citep{rothlisberger1972}.
This means that increased water discharge in subglacial channels can result in greater water velocity and thus sediment transport capacity.
  At the same time, a relatively  fixed channel width  means that the distance over sediment is mobilized does not evolve over the same timescale(s) as water discharge \citep[e.g.][]{werder2010}.
  
In fluvial systems with open-channel flow [why is this specified as compared with subglacial system? needed?], a commensurate [relative to ___?, delete?] increase in water discharge will be accommodated by  a reduced increase [whoa - hard to figure out] a reduction? in water velocity along with an increase in channel width and/or depth (Figure~\ref{fig:cartoon}\,b and d).
  The change in water velocity could be lower [not following here], but the width over which sediment can be mobilized changes \citep{leopold1953}.  [not following here, think through a clear explanation even if this requires more sentences. ]
  Thus, the systematic response in sediment transport capacity with respect to changing water discharge is  different in the two systems because ______________.
  
 Differences in the processes of ________________in subglacial and fluvial systems have been implicitly included in a wide range of available models that evaluate sediment transport relationships.  \citep[e.g.][]{walder1994,tucker1997,beaud2018,wickert2019}.
  Furthermore, models of \textbf{fluvial} [again, two uses of fluvial in this sentence is confusing] transport of sediment in glacial and \textbf{fluvial} systems investigate the relationship between sediment dynamics and climate change? \citep[e.g.][]{tucker1997,delaney2020}
 ...
 This manuscript leverages parameterizations of subglacial hydraulics and fluvial hydraulics to explore  differences in the relationships among sediment transport capacity and water discharge. It also explores  the impact of water discharge variability on sediment transport capacity in idealized? subglacial and fluvial  two systems.
  ...
  \begin{center}
    \begin{figure}[H]
      ...
      \caption{Cartoon of the situation with various parameters. Water? Velocity magnitude in the glacial, $v_g$ , and fluvial (river?) ______? ,$v_f$ ,systems are shown by arrow length and lines of ______greatest value? marks at the channel boundary. $S_g$ and $S_f$ represent the cross-sectional area in glacial and fluvial (river?) channels.  Note that in the fluvial channel parameterization, rectangular channel shapes are implemented (Section~\ref{sect:fluv}).} 
      \label{fig:cartoon}
    \end{figure}
  \end{center}
  ...
  \section{Methods}
  \label{sect:meth}
 Relationships among water discharge, subglacial water velocity, and channel geometry in both fluvial (river?) and subglacial channels (Table ___) are described with subglacial and fluvial(word?) parameterization models.
  Because sediment transport largely depends on shear stress applied by water flow \citep{shields1936}, both parameterizations calculatethis value and integrate  it across the channel bed (Fig. __).
  The evaluation of shear stress  omits a grain size parameter and, thus, leaves open the selection of a sediment transport relationship  \citep{shields1936}. and an eventual sediment transport capacity.  [is this what you mean?]
  ...
  To accomplish this, the hydraulics parameterization presented in \citet{delaney2019} is used. Here, it is assumed that the water is transported through subglacial channels \citep[Figure~\ref{fig:cartoon}; ][]{rothlisberger1972}, and that the? channel  and geometry shape and size? will respond to a representative water discharge over a certain time period $Q_{w}^*$, using the Darcy-Weisbach formulation for water-flow through a pipe  \citep[e.g.][]{rothlisberger1972,clarke2003,werder2013}.
  It is also assumed?? More, specifically,  the hydraulic diameter of the subglacial channel, $D_h$, responds to a representative water discharge, $Q_{w}^*$, and a representative gradient of the hydraulic potential, $\Psi^*$ such that:
  \begin{linenomath*}
    \begin{equation}
      \label{eq:DW}
  ...
  The width of the flat channel floor $w_c$ , where beta equals _____? is given by
  \begin{equation}
    \label{eq:dh2wc}
  ...
  Here, $Q_w$ represents the instantaneous water discharge; it is not used ?? to evaluate the hydraulic gradient of the channel in Equation~\ref{eq:DW}.
  It is assumed that?? the channel size is usually not in equilibrium with the quantity of water flowing through it.
  With this formulation, the processes in an R-channel can be represented algebraically \citep{delaney2019}. What is an "R-channel"? doesn't seem to be defined above.
 ...
 To parameterize?? describe? the shear stress of water flowing across sediments in the  fluvial channel  the hydraulics parameterization presented in \citet{tucker1997} is implemented.
  Here, it is assumed that there is  conservation of mass and a sufficiently wide channel so that the hydraulic radius, ____,  is consistent with flow depth, uniform flow, and the Darcy-Weisbach relationship.
 ...
 \begin{equation}
  ...
  The formulation for the _______ of the glacial system , eqn _____, requires inputs of the hydraulic gradient, ___, water discharge, ____, representative water discharge, ____,  Hooke angle $\beta$ \citep{hooke1990}, and friction factor, $f_r$. Help the reader find these quantities and equations!
  Values of $\beta$ and $f_r$ are chosen so that they produce reasonable values of water velocity, ___________ m/s, in accordance with  measurements made through dye-tracing \citep[Section~\ref{sect:sub_mode}, Figure~\ref{fig:model_outs}; e.g.][]{werder2010}. in xyz glacial environments.  Give the reader context for this!
  
  In the fluvial river? system, the water is not pressurized, so only the bed slope is needed to define the _____________, eqn ______. The friction factor, $f_f$ ,and channel shape factor, $k$, are assigned (Section~\ref{sect:fluv}), using xyz measurements from abc stream? river? environments.
  
  The Reynolds number $R_e$, which gives an evaluation of the ________________, is given as 
  \begin{equation}
    \label{eq:re}
    R_e\,=\, v \,\frac{D_h}{\nu},
  \end{equation}
  ...
  \end{equation}
  % 
  \noindent Below we examine variables, $\Gamma$, as water discharge ($Q_w$) water velocity ($v$, $v_f$), shear stress ($\tau$, $\tau_f$), and integrated shear stress ($\tau_t$, $\tau_{tf}$) with the purpose of evaluating __________________.
